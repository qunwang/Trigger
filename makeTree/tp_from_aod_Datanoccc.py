...
if "CMSSW_7_6_" in os.environ['CMSSW_VERSION']:
	...
	#"/store/group/phys_muon/hbrun/dataCommissioning/dataReRECOforTests/AODfile_run254790.root"
	"/store/user/quwang/Trigger/outputFULLnoccc.root"
	#"file:/afs/cern.ch/user/q/quwang/work/Trigger/CMSSW_7_6_3_patch2/src/HLTrigger/Configuration/test/outputFULL.root"
	#"file:/afs/cern.ch/user/q/quwang/work/Trigger/CMSSW_7_6_3_patch2/src/HLTrigger/Configuration/test/outputFULLccc.root"
    )
    print process.source.fileNames
...
if TRIGGER == "SingleMu":
    ...
    process.triggerResultsFilter.triggerConditions = cms.vstring( 'HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v*','HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v*',#'HLT_Mu8_v*', 'HLT_Mu17_v*',
...
if TRIGGER == "DoubleMu":
    process.tagMuons.cut = ("pt > 15 &&" +MuonIDFlags.Tight2012.value())

process.oneTag  = cms.EDFilter("CandViewCountFilter", src = cms.InputTag("tagMuons"), minNumber = cms.uint32(1))

process.probeMuons = cms.EDFilter("PATMuonSelector",
    src = cms.InputTag("patMuonsWithTrigger"),
    cut = cms.string("pt > 5 &&" +MuonIDFlags.Tight2012.value()),  # no real cut now
)
...
process.triggerResultsFilter.hltResults = cms.InputTag("TriggerResults","","TEST")
for module in process._Process__producers.values():
   if hasattr(module, 'processName'):
       setattr(module, 'processName', cms.string("TEST"))

process.TFileService = cms.Service("TFileService", fileName = cms.string("tnpZ_DatanoCCC.root"))
