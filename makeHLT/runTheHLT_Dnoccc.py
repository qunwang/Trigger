...
process.HLTSiStripClusterChargeCutTiny = cms.PSet(  value = cms.double( 0.0 ) )
...
process.streams = cms.PSet( 
  ...
  PhysicsEGammaCommissioning = cms.vstring( 'CastorJets',
    ...
    'ToTOTEM',
    'ZeroBias' ),
  PhysicsEndOfFill = cms.vstring( 'FullTrack',
    'HINCaloJets',
    'HINMuon',
    'HINPFJets',
    'HINPhoton',
...
process.datasets = cms.PSet( 
  AlCaElectron = cms.vstring( 'AlCa_Ele23_WPVeryLoose_Gsf_v1',
  ...
  BTagCSV = cms.vstring( 'HLT_DoubleJet90_Double30_DoubleBTagCSV0p67_v3',
  ...
  ExpressPhysics = cms.vstring( 'HLT_Ele17_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v3',
    ...
    'HLT_Random_v1',
    'HLT_ZeroBias_v2' ),
  FSQJets = cms.vstring( 'HLT_PFJet15_NoCaloMatched_v3',
    'HLT_PFJet20_NoCaloMatched_v3' ),
  ...
  HTMHT = cms.vstring( 'HLT_DiCentralPFJet55_PFMET110_v1',
    ...
    'HLT_Rsq0p25_v2',
    'HLT_Rsq0p30_v2',
    'HLT_RsqMR240_Rsq0p09_MR200_4jet_Calo_v1',
    'HLT_RsqMR240_Rsq0p09_MR200_4jet_v2',
    'HLT_RsqMR240_Rsq0p09_MR200_Calo_v1',
  ...
  JetHT = cms.vstring( 'HLT_AK8DiPFJet250_200_TrimMass30_BTagCSV0p45_v2',
    ...
    'HLT_DiCaloJetAve140_v1',
    'HLT_DiCaloJetAve200_v1',
    'HLT_DiCaloJetAve260_v1',
    'HLT_DiCaloJetAve320_v1',
    'HLT_DiCaloJetAve400_v1',
    'HLT_DiCaloJetAve40_v1',
    'HLT_DiCaloJetAve500_v1',
    'HLT_DiCaloJetAve60_v1',
    'HLT_DiCaloJetAve80_v1',
  ...
  LookAreaPD = ( cms.vstring( 'DST_CaloJet40_BTagScouting_v1',
    ...
    'HLT_IsoMu22_v2',
    'HLT_IsoMu24_eta2p1_CentralPFJet30_BTagCSV07_v4',
    'HLT_IsoMu24_eta2p1_TriCentralPFJet30_v4',
    'HLT_IsoMu24_eta2p1_TriCentralPFJet50_40_30_v4',
    'HLT_IsoMu24_eta2p1_v3',
    'HLT_IsoMu27_v3',
    'HLT_IsoTkMu18_v2',
    'HLT_IsoTkMu20_eta2p1_v3')+cms.vstring( 'HLT_IsoTkMu20_v4',
    'HLT_IsoTkMu22_v2',
    ...
    'HLT_PixelTracks_Multiplicity135_v2',
    'HLT_PixelTracks_Multiplicity160ForEndOfFill_v1',
    'HLT_PixelTracks_Multiplicity160_v2')+cms.vstring( 'HLT_PixelTracks_Multiplicity60ForEndOfFill_v1',
    'HLT_PixelTracks_Multiplicity60_v2',
    ...
    'HLT_ZeroBias_v2') ),
  MET = cms.vstring( 'HLT_CaloMHTNoPU90_PFMET90_PFMHT90_IDTight_BTagCSV0p72_v2',
    'HLT_CaloMHTNoPU90_PFMET90_PFMHT90_IDTight_v2',
    'HLT_MET100_v1',
    'HLT_MET150_v1',
    'HLT_MET200_v1',
  ...
  TOTEM_minBias = cms.vstring( 'HLT_L1TOTEM1_MinBias_v1',
    'HLT_L1TOTEM3_ZeroBias_v1' ),
  TOTEM_romanPots = cms.vstring( 'HLT_L1RomanPots_SinglePixelTrack04_v2',
    'HLT_L1RomanPots_v2',
    'HLT_L1TOTEM0_RomanPotsAND_v1' ),
  Tau = cms.vstring( 'HLT_DoubleMediumIsoPFTau35_Trk1_eta2p1_Reg_v2',
    ...
    'HLT_LooseIsoPFTau50_Trk30_eta2p1_MET80_v1',
    'HLT_LooseIsoPFTau50_Trk30_eta2p1_v3' ),
  Templates = cms.vstring( 'HLT_BTagCSV07_v2',
    'HLT_CaloJet260_v2',
    'HLT_DoubleMediumIsoPFTau40_Trk1_eta2p1_v4',
    'HLT_Ele17_Ele8_Gsf_v3',
...
process.hltL1sL1DoubleMu103p5ORDoubleMu125 = cms.EDFilter( "HLTLevel1GTSeed",
    L1SeedsLogicalExpression = cms.string( "L1_DoubleMu_10_3p5 OR L1_DoubleMu_12_5" ),
...
process.hltL1fL1sDoubleMu103p5ORDoubleMu125L1Filtered0 = cms.EDFilter( "HLTMuonL1Filter",
    saveTags = cms.bool( False ),
    CSCTFtag = cms.InputTag( "unused" ),
    PreviousCandTag = cms.InputTag( "hltL1sL1DoubleMu103p5ORDoubleMu125" ),
...
process.hltL2pfL1sDoubleMu103p5L1f0L2PreFiltered0 = cms.EDFilter( "HLTMuonL2PreFilter",
    saveTags = cms.bool( True ),
...
process.hltL2fL1sDoubleMu103p5L1f0L2Filtered10OneMu = cms.EDFilter( "HLTMuonL2PreFilter",
    saveTags = cms.bool( True ),
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
    PreviousCandTag = cms.InputTag( "hltL1fL1sDoubleMu103p5ORDoubleMu125L1Filtered0" ),
...
process.hltL3pfL1sDoubleMu103p5L1f0L2pf0L3PreFiltered8 = cms.EDFilter( "HLTMuonL3PreFilter",
...
process.hltL3fL1sDoubleMu103p5L1f0L2f10OneMuL3Filtered17 = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 9999.0 ),
    saveTags = cms.bool( True ),
...
process.hltDiMuonGlb17Glb8RelTrkIsoFiltered0p4 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3pfL1sDoubleMu103p5L1f0L2pf0L3PreFiltered8" ),
    MinN = cms.int32( 2 ),
...
process.hltL1fL1sDoubleMu103p5L1OneMuFiltered0 = cms.EDFilter( "HLTMuonL1Filter",
    saveTags = cms.bool( False ),
    CSCTFtag = cms.InputTag( "unused" ),
    PreviousCandTag = cms.InputTag( "hltL1sL1DoubleMu103p5ORDoubleMu125" ),
    MinPt = cms.double( 0.0 ),
...
process.hltL2fL1sDoubleMu103p5L1f0OneMuL2Filtered10 = cms.EDFilter( "HLTMuonL2PreFilter",
    ...
    MaxDr = cms.double( 9999.0 ),
    CutOnChambers = cms.bool( False ),
    PreviousCandTag = cms.InputTag( "hltL1fL1sDoubleMu103p5L1OneMuFiltered0" ),
    MinPt = cms.double( 10.0 ),
    MinN = cms.int32( 1 ),
    SeedMapTag = cms.InputTag( "hltL2Muons" ),
    MaxEta = cms.double( 2.5 ),
...
process.hltL3fL1sDoubleMu103p5L1f0L2f10L3Filtered17 = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 9999.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sDoubleMu103p5L1f0OneMuL2Filtered10" ),
    MinNmuonHits = cms.int32( 0 ),
    MinN = cms.int32( 1 ),
    MinTrackPt = cms.double( 0.0 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltL3fL1sMu12L1f0L2f12L3Filtered17 = cms.EDFilter( "HLTMuonL3PreFilter",
    MaxNormalizedChi2 = cms.double( 9999.0 ),
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL2fL1sMu12L1f0L2Filtered12" ),
    MinNmuonHits = cms.int32( 0 ),
    MinN = cms.int32( 1 ),
    MinTrackPt = cms.double( 0.0 ),
    MaxEta = cms.double( 2.5 ),
...
process.hltL3fL1sMu12L1f0L2f12L3Filtered17TkIsoFiltered0p4 = cms.EDFilter( "HLTMuonIsoFilter",
    saveTags = cms.bool( True ),
    PreviousCandTag = cms.InputTag( "hltL3fL1sMu12L1f0L2f12L3Filtered17" ),
    MinN = cms.int32( 1 ),
    IsolatorPSet = cms.PSet(  ),
    CandTag = cms.InputTag( "hltL3MuonCandidates" ),
    DepTag = cms.VInputTag( 'hltL3MuonRelTrkIsolationVVL' )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v2, process.HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_v2, process.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_v2, process.HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v2, process.HLT_Mu17_TrkIsoVVL_v2, process.HLTriggerFinalPath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_1.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_2.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_3.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_4.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_5.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_6.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_7.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_8.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_9.root',
        '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_10.root',
    ),
...
process.hltOutputFULL = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string( "/tmp/quwang/outputFULLnoccc.root" ),
    ...
    outputCommands = cms.untracked.vstring(
        *(
          ...
          'keep *_hltL1GtObjectMap_*_TEST',
          'drop L1GlobalTriggerObjectMapRecord_hltL1GtObjectMap_*_TEST',
...
process.dqmOutput = cms.OutputModule("DQMRootOutputModule",
    fileName = cms.untracked.string("DQMIOnoccc.root")
)
...
_customInfo['inputFile' ]=  ['/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_1.root',
			     '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_2.root',
			     '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_3.root',
			     '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_4.root',
			     '/store/group/phys_muon/hbrun/HLTtest/SkimsHLT/ZMuSkim/DoubleMuon/skimMerged/skimMerged_5.root',
