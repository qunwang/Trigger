...
void cleanPairs_double(){
   ...
   Int_t EffMu17Mu8nodzMu22, EffMu17TkMu8nodzMu22, pathOrnodzMu22, EffMu17Mu8Mu22, EffMu17TkMu8Mu22, pathOrMu22;
   Int_t Mu22Eff;
...
/////////////////////leg with Iso  9 lines below is new for 8X
    ...
    tIn->SetBranchAddress("tag_IsoTkMu22", &tag_IsoTkMu22);
    ...
    //TFile *fOut = new TFile("/afs/cern.ch/user/q/quwang/eos/cms/store/user/quwang/Trigger/tnpZ_theTreeCleaned_data_eff_Mu17Mu8Clean_ICHEPrun_BCDdoub22.root", "RECREATE");
////////////////Lumi lumi reweight//////////////////
//    TFile * lumiWeight = new TFile("theOutputFile_BCDv2.root");
//    TH1F * h_lumiWeight = (TH1F *)lumiWeight->Get("theRatio");
    //TFile *fOut = new TFile("~/eos/cms/store/user/quwang/Trigger/Run_BCDEF/tnpZ_theTreeCleaned_data_eff_Mu17Mu8Clean_runBCDEFdoub22.root", "RECREATE");
    TFile *fOut = new TFile("/tmp/quwang/tnpZ_theTreeCleaned_Data_eff_Mu17Mu8Clean_runBCDEF.root", "RECREATE");
...
// nodz 
    ...
    tOut->Branch("Mu22Eff", &Mu22Eff, "Mu22Eff/I)");
    tOut->Branch("EffMu17Mu8nodzMu22", &EffMu17Mu8nodzMu22, "EffMu17Mu8nodzMu22/I)");
    tOut->Branch("EffMu17TkMu8nodzMu22", &EffMu17TkMu8nodzMu22, "EffMu17TkMu8nodzMu22/I)");
    tOut->Branch("pathOrnodzMu22", &pathOrnodzMu22, "pathOrnodzMu22/I)");
    tOut->Branch("EffMu17Mu8Mu22", &EffMu17Mu8Mu22, "EffMu17Mu8Mu22/I)");
    tOut->Branch("EffMu17TkMu8Mu22", &EffMu17TkMu8Mu22, "EffMu17TkMu8Mu22/I)");
    tOut->Branch("pathOrMu22", &pathOrMu22, "pathOrMu22/I)");
...
//      hr2DMCTrue -> Fill(abseta, tag_eta);
	...
	if((Mu17||tag_Mu17) && combRelIsoPF04dBeta<0.25 && tag_combRelIsoPF04dBeta<0.25 && Tight2012 && tag_Tight2012 && tag_pt>20 && pt>20){
	//if((Mu17||tag_Mu17) && combRelIsoPF04dBeta<0.25 && tag_combRelIsoPF04dBeta<0.25 && Tight2012 && tag_pt>20 && pt>20){
...
// HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL
       ...
       // ----------- ref trigger Mu 17
        ...
        Mu22Eff = 0;
        //if(Mu17_IsoTrkVVL||tag_Mu17_IsoTrkVVL)
        if(IsoMu22||tag_IsoMu22||IsoTkMu22||tag_IsoTkMu22)
        Mu22Eff = 1;

	EffMu17Mu8nodzMu22 = 0;
	if(EffMu17Mu8nodz || Mu22Eff)
	EffMu17Mu8nodzMu22 = 1;

	EffMu17TkMu8nodzMu22 = 0;
	if(EffMu17TkMu8nodz || Mu22Eff)
	EffMu17TkMu8nodzMu22 = 1;

	pathOrnodzMu22 = 0;
	if(pathOrnodz || Mu22Eff)
	pathOrnodzMu22 = 1;

	EffMu17Mu8Mu22 = 0;
	if(EffMu17Mu8 || Mu22Eff)
	EffMu17Mu8Mu22 = 1;

	EffMu17TkMu8Mu22 = 0;
	if(EffMu17TkMu8 || Mu22Eff)
	EffMu17TkMu8Mu22 = 1;
