...
void  eff_Mu17TkMu8(){
 ...
 gStyle -> SetErrorX(0);
  ...
  // TFile *fdataeff= new TFile("output_mc_test.root");
 TString RunBin = "late";
// TString RunBin = "early";
   TFile *fdataeff= new TFile("output_Data_"+RunBin+"_test.root");
 //   TFile *fdataeff= new TFile("../output_Data_test.root");
...
fdataeff->ls();
//  tag_abseta_bin0
//TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin1
//TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin1_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin1_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin2
//TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin2_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin2_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin3
//TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin3_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17TkMu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin3_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
...
TH1F  *hrEffB = (TH1F*)heta1eta2 -> Clone(); 
   t->SetTextColor(1);
   t->SetTextSize(0.04);
   t->DrawLatex(0.02,0.95, "(HLT_Mu17_TkMu8 && HLT_Mu17) /  HLT_Mu17" );
//////////////////////////////////////////////////
...
//   c-> Print("eff_Mu17TkMu8_mc_iso025.pdf"); 
   c-> Print("eff_Mu17TkMu8_data_new_"+RunBin+".pdf"); 
   c-> Print("eff_Mu17TkMu8_data_new_"+RunBin+".png"); 

//c-> Print("eff_Mu17TkMu8_mc_new_nodz.pdf"); 
