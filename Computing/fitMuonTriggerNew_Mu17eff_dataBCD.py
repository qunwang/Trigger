...
if "Data" in scenario:
    process.TnP_MuonID.InputFileNames = cms.vstring(
                                                    ...
                                                    #"file:/tmp/quwang/tnpZ_theTreeCleaned_data_eff_Mu17Mu8Clean_ICHEPrunBCDmu17.root"
						    #"file:/afs/cern.ch/user/q/quwang/eos/cms/store/user/quwang/Trigger/Run_BCDEF/TnPTree_80XRereco_Run2016E_GoldenJSON_Run276098to276384.root",
						    #"file:/afs/cern.ch/user/q/quwang/eos/cms/store/user/quwang/Trigger/Run_BCDEF/TnPTree_80XRereco_Run2016F_GoldenJSON_Run276098to276384.root"
						    #"file:/tmp/quwang/data_prompt_Json800fb.root"
						    #"file:/tmp/quwang/skimmedTree_TnPTree_Run2016BCDEF_GoldenJSON_Run276098to276384.root"
						    #"file:/afs/cern.ch/user/q/quwang/work/Trigger/CMSSW_8_0_13/src/MuonAnalysis/TagAndProbe/test/zmumu/python_2016_BCDEF/skimmedTree_RUN2016BCDEF_GoldenJSON_Run276098to276384.root"
						    #"file:/tmp/quwang/skimmedTree_Run2016D_GoldenJSON_Run276098to276384.root"
						    "file:/tmp/quwang/tnpZ_theTreeCleaned_data_Mu17Mu8Clean_ICHEP_runBCDEFmu17.root"
						    #"file:/tmp/quwang/skimmedTree_data_reRECO_Moriond17_Run2016.root"
                                                    )
...
for ID in IDS:
    ...
    for X,B in ALLBINS:
        ...
        module = process.TnP_MuonID.clone(OutputFileName = cms.string("TnP_MuonID_%s_%s_%stestMar06.root" % (scenario, ID, X)))
        shape = "vpvPlusExpo"
