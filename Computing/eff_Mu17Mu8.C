...
//TGraphAsymmErrors *histo1Da = (TGraphAsymmErrors*) fdataeff->Get("Mu17_pt_eta_abseta_PLOT_Tight2012_pass_&_tag_Mu17_pass");
histo1Da ->Draw("ap");
...
fdataeff->ls();
//  tag_abseta_bin0
//TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
//TGraphAsymmErrors  *histo1D = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin0_&_Mu17Eff_pass_&_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin1
//TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin1_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin1_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
//TGraphAsymmErrors  *histo1Db1 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin1_&_Mu17Eff_pass_&_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin2
//TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin2_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin2_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
//TGraphAsymmErrors  *histo1Db2 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin2_&_Mu17Eff_pass_&_Tight2012_pass");
...
cout << "--------------" << "\n";
//  tag_abseta_bin3
//TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodzMu22_pt_eta_abseta_PLOT_tag_abseta_bin3_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin3_&_Mu17Eff_pass_&_Tight2012_pass_&_tag_Tight2012_pass");
//TGraphAsymmErrors  *histo1Db3 = (TGraphAsymmErrors*) fdataeff->Get("EffMu17Mu8nodz_pt_eta_abseta_PLOT_tag_abseta_bin3_&_Mu17Eff_pass_&_Tight2012_pass");
...
heta1eta2->SetAxisRange(0.700, 1.0, "z");
heta1eta2 -> Draw("COLZ");
gStyle->SetPaintTextFormat("3.4f ");
...
//   c_4 -> cd();
   ...
   gStyle->SetPalette(1);
   hrEffA->SetAxisRange(0.700, 1.0, "z");
   hrEffA->Draw("COLZ");
...
//hrEffFinFormula -> Write();
   ...
   hrEffB->SetTitle("(HLT_Mu17_Mu8 && HLT_Mu17) /  HLT_Mu17");
...
/////////////////////////////////////////////////////////////
   ...
   c-> Print("eff_Mu17Mu8_data_new_"+RunBin+".pdf"); 
   c-> Print("eff_Mu17Mu8_data_new_"+RunBin+".png"); 
