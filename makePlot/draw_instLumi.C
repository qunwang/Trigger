...
void draw_instLumi(){
	...
	Float_t xbins[16] = { 2800, 3000, 3200, 3400, 3450, 3500, 3550, 3600, 3650, 3700, 3750, 3800, 3850, 3900,3950, 4000};
	TH1F * hbx = new TH1F("hbx","hbx", 15, xbins);
	TH1F * hbx_a = new TH1F("hbx_a","hbx_a", 15, xbins);
	TH1F * hbx_dZ = new TH1F("hbx_dZ","hbx_dZ", 15, xbins);
	TH1F * hbxD = new TH1F("hbxD","hbxD", 15, xbins);
	TH1F * hbxD_a = new TH1F("hbxD_a","hbxD_a", 15, xbins);
	TH1F * hbxD_dZ = new TH1F("hbxD_dZ","hbxD_dZ", 15, xbins);
	TH1F * hbxDno_a = new TH1F("hbxDno_a","hbxDno_a", 15, xbins);
	TH1F * hbxDno_dZ = new TH1F("hbxDno_dZ","hbxDno_dZ", 15, xbins);
	//TH1F * hbx = new TH1F("hbx","hbx", 70, 0, 3500);
	//TH1F * hbx_a = new TH1F("hbx_a","hbx_a", 70, 0, 3500);
	//TH1F * hbx_dZ = new TH1F("hbx_dZ","hbx_dZ", 70, 0, 3500);
	//TH1F * hbxD = new TH1F("hbxD","hbxD", 70, 0, 3500);
	//TH1F * hbxD_a = new TH1F("hbxD_a","hbxD_a", 70, 0, 3500);
	//TH1F * hbxD_dZ = new TH1F("hbxD_dZ","hbxD_dZ", 70, 0, 3500);
	...
	for(Long64_t i=0; i< treeDatanoCCC->GetEntries(); i++){
        ...
        hbx_DM->SetMaximum(1.2);
        hbx_DM->SetMinimum(0.8);
        hbx_DM->SetStats(kFALSE);
        hbx_DM->GetXaxis()->SetLabelSize(0.09);
        ...
        hbx_DMN->Draw("same");
	TLine * lineAtZero = new TLine(hbx_DM->GetXaxis()->GetXmin(), 1, hbx_DM->GetXaxis()->GetXmax(), 1);
	lineAtZero->SetLineColor(2);
	lineAtZero->SetLineStyle(2);
	lineAtZero->Draw();

        C->SaveAs("dZ_instLumi_check.pdf");
